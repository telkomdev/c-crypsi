...
int main(int argc, char** argv) {
    ...
    if(crypsi_aes_128_gcm_encrypt(key_128, burger_stream, burger_stream_length, &dst, &dst_len) != 0) {
    ...
    if (write_file("./testdata/burger_aes_128_gcm_encrypted.bin", dst, dst_len) != 0) {
      printf("writing encrypted data to file error\n");
      free((void*) dst);
      free((void*) burger_stream);
      return -1;
    }

    printf("encrypted data written to the file\n");
